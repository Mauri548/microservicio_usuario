...
export default {
    ...
    setup(){
        ...
        watchEffect(()=>{
            ...
            listas.value[1].opc[0].nombre = i18n.global.locale == 'en'? 'Apps management': 'Gestión de aplicaciones'
            listas.value[1].opc[1].nombre = i18n.global.locale == 'en'? 'Licences management': 'Gestión de licencias'
            listas.value[1].opc[2].nombre = i18n.global.locale == 'en'? 'LabelKeys management': 'Tabla de Label Keys'
            listas.value[1].opc[3].nombre = i18n.global.locale == 'en'? 'Permissions': 'Permisos'
